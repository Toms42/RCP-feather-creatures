...
class AppWindow(QtWidgets.QMainWindow):
    ...
    def _setupUi(self):
        ...
        self.mainLayout = QtWidgets.QVBoxLayout(self.midiTab)
...
class MotionPrimitives(object):
    ...
    def process_cue(self, args):
        if args[0] == 'pose':
            self.set_pose(args[1], robot=0)
            self.set_pose(args[1], robot=1)
...
class MainApp(rcp.app.MainApp):
    ...
    def frame_timer_tick(self):
        ...
        #print(self.winches[0].winch_positions)
